...
class COCO:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            ...
            #dataset = json.load(open(annotation_file, 'r')) # avoid 'str' vs byte error
            dataset = annotation_file
            #print(datetime.datetime.utcnow() - time_t) # avoid 'str' vs byte error
            self.dataset = dataset
            self.createIndex()

    def createIndex(self):
        # create index
        #print('creating index...') # avoid 'str' vs byte error
        ...
        #print('index created!') # avoid 'str' vs byte error
    ...
    def info(self):
        ...
        for key, value in self.datset['info'].items():
            #print('%s: %s'%(key, value)) # avoid 'str' vs byte error
            pass
